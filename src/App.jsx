            ...
            <div style={{ overflowX: "auto" }}>
              <div style={{ display: "inline-block", minWidth: "100%" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: `80px repeat(${sortedDates.length}, minmax(110px, 1fr))`, gap: "2px", marginBottom: "2px" }}>
                  <div style={{ position: "sticky", left: 0, background: colors.black, zIndex: 2, borderRadius: "4px", boxShadow: "3px 0 6px rgba(0,0,0,0.08)" }}></div>
                  {sortedDates.map(d => (
                  ...
                  return times.map(tkey => {
                    ...
                    return (
                      <div key={tkey} style={{ display: "grid", gridTemplateColumns: `80px repeat(${sortedDates.length}, minmax(110px, 1fr))`, gap: "2px", marginBottom: "2px" }}>
                        <div style={{ padding: "4px 6px", fontSize: "11px", color: "white", textAlign: "right", fontVariantNumeric: "tabular-nums", position: "sticky", left: 0, background: colors.black, zIndex: 1, borderRadius: "4px", fontWeight: 500, boxShadow: "3px 0 6px rgba(0,0,0,0.08)" }}>
                          {formatTime(hh, mm)}
                        </div>
                        {sortedDates.map(d => {
          ...
          <div style={{ background: "white", border: `1px solid ${colors.border}`, borderRadius: "12px", padding: "16px", overflowX: "auto" }}>
            <div style={{ display: "inline-block", minWidth: "100%" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: `72px repeat(${sortedDates.length}, minmax(90px, 1fr))`, gap: "3px", marginBottom: "3px", position: "sticky", top: 0, background: "white", zIndex: 3 }}>
                <div style={{ fontSize: "11px", color: "white", padding: "6px 4px", textAlign: "right", position: "sticky", left: 0, background: colors.black, zIndex: 4, borderRadius: "6px", fontWeight: 500, boxShadow: "3px 0 6px rgba(0,0,0,0.08)" }}>{tzLabel}</div>
                {sortedDates.map(d => (
              ...
              {times.map(tkey => {
                ...
                return (
                  <div key={tkey} style={{ display: "grid", gridTemplateColumns: `72px repeat(${sortedDates.length}, minmax(90px, 1fr))`, gap: "3px", marginBottom: "3px" }}>
                    <div style={{ padding: "4px 6px", fontSize: "11px", color: "white", textAlign: "right", fontVariantNumeric: "tabular-nums", alignSelf: "stretch", position: "sticky", left: 0, background: colors.black, zIndex: 2, borderRadius: "4px", fontWeight: 500, boxShadow: "3px 0 6px rgba(0,0,0,0.08)", display: "flex", alignItems: "center", justifyContent: "flex-end" }}>
